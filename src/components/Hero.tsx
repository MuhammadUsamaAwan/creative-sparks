      ...
      <SimpleGrid cols={2} px='lg'>
        <Stack mt={160}>
          ...
          <Text>
            ...
            Explore stunning galleries, discover unique techniques, and join a thriving community that shares your
            passion for self-expression. Let your imagination soar and make this your haven for artistic exploration!
          </Text>
          <div>
